...
class SiameseNetworkTestDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img0_tuple = ['./apps/resource/support/query/query.jpg']
        img1_tuple = ['./apps/resource/support/s{}/img{}.jpg'.format(SiameseNetworkTestDataset.i, SiameseNetworkTestDataset.j)]
